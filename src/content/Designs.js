...
const Designs = [
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        perseverance the race marked out for us, fixing our eyes on Jesus, the pioneer and perfecter
        of faith. For the joy set before him he endured the cross, scorning its shame, and sat down
        at the right hand of the throne of God. Consider him who endured such opposition from
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <br />
        <br />
        Adonai is the Hebrew word for “Lord,” a title that expresses God’s supreme sovereignty and
        absolute power. Psalm 8:1 thus reads, “O YHWH, our Adonai,” our Almighty King.
        {/* <h3>
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <br />
        <br />
        According to Isaiah, “we all, like sheep, have gone astray; we have turned—every one—to his
        own way” (Isaiah 53:6). He declares that “there is none who does good, not even one” (Psalm
  ...
  },
  {
    ...
    description: (
      <div>
        To be holy means to be S E T // A P A R T, to be completely distinct, to be in a class of
        one’s own. When God says that He is holy, He means that He is completely set apart from
        everything else. From the beginning, God created and set apart humanity to bear His image
        and display His holiness to all of Creation, but we rebelled in sin and we fell short of His
        glory. (Genesis 1:26-27, Romans 1:25, Romans 3:23)
        {/* <h3>
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        Jehovah Rohi, The Lord Our Shepherd, as David declares our relationship to God like sheep to
  ...
  },
  {
    ...
    description: (
      <div>
        SELAH means to “pause and praise”, carefully weighing the value of what has just been said.
        Our team created SELAH to remind ourselves to have a posture of measuring the weight of the
        Word, pausing, and turning it back into praise.
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div>
        We say we’re athletes, artists, students. We identify ourselves by personality type and
        pride ourselves in being perceived as polite, good looking, or well-liked. We tell the world
        we go to this college, or we’re dating that person; We say, “Look at where I've been. Look
  ...
  },
  {
    ...
    description: (
      <div>
        Beautiful, majestic King. He rules with grace, even when we cannot fathom the depths of His
        grace.
        <br />
        <br />
  ...
  },
  {
    ...
    description: (
      <div>
        Mountains are often associated with sheer might--the idea that if only we had enough power,
        we could move huge obstacles. When we face trials that seem to exceed our strengths, let us
        instead surrender our inabilities at the feet of our Father, whose strength is made perfect
        in our weakness. From a distance, our daunting challenges seem unshakeable, but when we
        patiently put our trust in God and approach with His full confidence, we will begin to see
        how far He has moved our mountains.
      </div>
    ),
