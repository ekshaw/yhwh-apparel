...
const organizations = {
  ...
  missionaryHeadline: 'Here are some organizations that you’ve supported who are responding to this call of Jesus. Join us in praying for these groups and the people they come across so that the love of God would be made known.',
  missionaries: [
    {
      name: 'Laundry Love',
      imgSrc: require('../images/community-outreach/laundrylove.png'),
