...
import '../../styles/desktop/PartnershipsPageDesktop.css';

const PartnershipsPageDesktop = props => {
  return (
    <div className='partnerships-main-container'>
      <div className='partnerships-container'>
        <div className='partnerships-caption-container'>
          <div className='partnerships-caption'>
            <h1>Partnerships.</h1>
          </div>
      ...
      <div className='missionaries-container'>
        <div className='missionaries-caption-container'>
          <div className='missionaries-caption'>
            <h1>Missionaries.</h1>
          </div>
        ...
        <div className='missionaries-philippines-container'>
          <div className='missionaries-philippines-image'>
            <img src={require('../../images/partnerships/philippines.jpg')}></img>
          </div>
          <div className='missionaries-philippines-title'>
            <h2>Epic Philippines Vision Team</h2>
          </div>
          <div className='missionaries-philippines-time-date'>
            <h4>
              MANILA, PHILIPPINES
              <br />
              MAY 31ST - JUNE 14TH, 2018
            </h4>
          </div>
        ...
        <div className='missionaries-eads-container'>
          <div className='missionaries-eads-blank-image-box' />
          <div className='missionaries-eads-image'>
            <img src={require('../../images/partnerships/eads.jpg')}></img>
          </div>
          <div className='missionaries-eads-title'>
            <h2>El Amor del Señor</h2>
          </div>
          <div className='missionaries-eads-time-date'>
            <h4>
              SAN TELMO, MEXICO <br />
              MARCH 2ND - 4TH, 2018
            </h4>
        ...
        <div className='missionaries-david-container'>
          <div className='missionaries-david-blank-image-box' />
          <div className='missionaries-david-image'>
            <img src={require('../../images/partnerships/david.jpg')}></img>
          </div>
          <div className='missionaries-david-title'>
            <h2>David</h2>
          </div>
          <div className='missionaries-david-time-date'>
            <h4>
              NAVAJO RESERVATION, ARIZONA
              <br />
              JUNE 25TH - JULY 3RD, 2017
            </h4>
          </div>
        ...
        <div className='missionaries-isabella-johannah-container'>
          ...
          <div className='missionaries-isabella-johannah-time-date'>
            <h4>
              GREECE
              <br />
              JUNE 25TH - JULY 3RD, 2017
        ...
        <div className='missionaries-briana-container'>
          <div className='missionaries-briana-image'>
            <img src={require('../../images/partnerships/briana.jpg')}></img>
          </div>
          <div className='missionaries-briana-title'>
            <h2>Briana</h2>
          </div>
          <div className='missionaries-briana-time-date'>
            <h4>
              DUBLIN, IRELAND
              <br />
      ...
      <div className='organizations-container'>
        ...
        <div className='organizations-laundry-love'>
          <div className='organizations-laundry-love-caption-container'>
            <div className='organizations-laundry-love-title'>
              <h2>Laundry Love</h2>
            </div>
            <div className='organizations-laundry-love-location'>
              <h4>BING WONG WASH CENTER, BERKELEY, CALIFORNIA</h4>
            </div>
      ...
      <div className='in-touch-container'>
        <div className='in-touch-caption-container'>
          <div className='in-touch-caption'>
            <h1>Get in Touch with Us.</h1>
          </div>
          <div className='in-touch-description'>
            <h3>
              If you... <br />
...
export default PartnershipsPageDesktop;
